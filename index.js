...
async function runScenario(feature, scenarios, datetime, b, resultInfo) {
  for (var i = 1; i <= scenarios; i++) {
    ...
    const data = await compareImages(
      fs.readFileSync(`./assets/${feature}/V1E${i}.png`),
      fs.readFileSync(`./assets/${feature}/V2E${i}.png`),
      options
    );
    resultInfo[b] = {
  ...
  return `<div class=" browser" id="test0">
    ...
    <div class="imgline">
      <div class="imgcontainer">
        ...
        <img class="img2" src="../../../assets/${feature}/V1E${scenario}.png" id="refImage" label="Reference">
      </div>
      <div class="imgcontainer">
        <span class="imgname">Test</span>
        <img class="img2" src="../../../assets/${feature}/V2E${scenario}.png" id="testImage" label="Test">
      </div>
    </div>
    <div class="imgline">
      <div class="imgcontainer">
